...
//   body('totalFeesPaid').optional().isNumeric(),
//   body('scholarshipAmount').optional().isNumeric(),
//   body('pendingFees').optional().isNumeric(),
//   body('isActive').optional().isBoolean(),
//   // body('lastFeePaymentDate').optional().isISO8601().toDate(),
//   // body('nextFeeDueDate').optional().isISO8601().toDate(),
//   // body('emailStatus').optional().isIn(['SENT', 'NOT_SENT']),
// ], async (req, res) => {
//   let success = false;
//   const errors = validationResult(req);
//   if (!errors.isEmpty()) {
...
//     if (existingStudent) {
//       return res.status(400).json({ success, error: 'Student with this email already exists.' });
//     }
...
//   body('name').isLength({ min: 3 }),
//   body('email').isEmail(),
//   body('course').isMongoId().withMessage('Invalid course ID'), // Validate if the course ID is a valid MongoDB ObjectId
//   body('admissionDate').optional().isISO8601().toDate(), // Optional field validation for admissionDate
//   body('totalFeesPaid').optional().isNumeric(), // Optional field validation for totalFeesPaid
//   body('scholarshipAmount').optional().isNumeric(), // Optional field validation for scholarshipAmount
//   body('pendingFees').optional().isNumeric(), // Optional field validation for pendingFees
//   body('isActive').optional().isBoolean(), // Optional field validation for isActive
//   body('lastFeePaymentDate').optional().isISO8601().toDate(), // Optional field validation for lastFeePaymentDate
//   body('nextFeeDueDate').optional().isISO8601().toDate(), // Optional field validation for nextFeeDueDate
//   body('emailStatus').optional().isIn(['SENT', 'NOT_SENT']), // Optional field validation for emailStatus
// ], async (req, res) => {
//   let success = false;
//   const errors = validationResult(req);
//   if (!errors.isEmpty()) {
...
//   const { name, email, course, admissionDate, totalFeesPaid, scholarshipAmount, pendingFees, isActive, lastFeePaymentDate, nextFeeDueDate, emailStatus } = req.body;
